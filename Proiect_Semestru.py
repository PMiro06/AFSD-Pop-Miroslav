...
class SemaforInteligentApp:
    def __init__(self, root):
        ...
        # Starea intersecției (număr de mașini virtuale care așteaptă)
        self.masini_NS = random.randint(5, 20)
        self.masini_EV = random.randint(5, 20)

        # Starea semafoarelor: True = Verde pentru NS (Roșu pentru EV), False = Verde pentru EV (Roșu pentru NS)
        self.verde_NS = True
        self.timp_ramas = 10
    ...
    def creeaza_interfata(self):
        ...
        # Afișaj timpi și mașini pe canvas
        self.txt_timp = self.canvas.create_text(270, 290, text="", font=("Arial", 24, "bold"), fill="yellow")
        self.txt_masini_NS = self.canvas.create_text(270, 50, text="", font=("Arial", 14, "bold"), fill="white")
        self.txt_masini_EV = self.canvas.create_text(90, 290, text="", font=("Arial", 14, "bold"), fill="white")
